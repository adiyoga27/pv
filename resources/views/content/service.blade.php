            ...
            <div class="modal-content">
                ...
                <form action="{{ route('service.store') }}" method="POST"  enctype="multipart/form-data">
                    <div class="modal-body">
                        ...
                        <div class="mb-3 row">
                            <label for="example-text-input" class="col-md-2 col-form-label">Komisi</label>
                            <div class="col-md-10">
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                      <span class="input-group-text" id="basic-addon1">Rp</span>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-10">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" value="1" name="is_active" id="flexRadioDefault1">
                                    <label class="form-check-label" for="flexRadioDefault1">
                                     Aktif
                                    </label>
                                  </div>
                                  <div class="form-check">
                                    <input class="form-check-input" type="radio" value="0" name="is_active" id="flexRadioDefault2" checked>
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.status) {
                        ...
                        modal.find('#commission').val(response.data['commission']);
